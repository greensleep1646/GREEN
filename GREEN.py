...
def logo():
    print("""greensleepden/greenkid den selamlar.d   
    """)

def logo2():
        print("""coded by greensleep/greenkidd  
    """)
...
def baslangic():
    ...
    if secim=="2":
        ...
        def toolsdownload():
            ...
            print(options)
            secimtools=input("root""\033[1;91m@GREENKİD:~$\033[1;m ")
            if secimtools=="1":
                print(download)
